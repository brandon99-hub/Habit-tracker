...
import { Eye, EyeOff, CheckCircle2, Sparkles, UserPlus } from "lucide-react"
            ...
            <div className="relative z-10 w-full max-w-md animate-scale-in">
                ...
                <div className="glass dark:glass-dark rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-white/80 dark:text-white/60">Create your account to get started</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        {/* Name field */}
                        <div className="space-y-2">
                            <Label htmlFor="name" className="text-white/90 dark:text-white/70">
                                Name
                            </Label>
                            <Input
                                id="name"
                ...
                <p className="mt-6 text-center text-sm text-white/60">
                    Join thousands organizing their tasks ✨
                </p>
            </div>
        </div>
    )
